...
public static HOME_CONTROL_API_ENDPOINT: string = 'https://localhost:8053/api/v1/Room/'; 
...
public static HOME_CONTROL_API_HEALTH: string = 'https://localhost:8053/health'; 
